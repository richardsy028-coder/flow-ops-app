...
echo "Applying documented frontend fix to index.html..."
...
# Replace first script block only
...
print("✅ index.html updated with documented safe frontend.")
PY

echo "🔍 Checking for bad .json()..."
grep -n "json()" index.html || echo "✅ No .json() found"

echo ""
echo "🚀 Now deploy:"
echo "git add ."
echo "git commit -m 'apply documented frontend fix'"
echo "git push"
